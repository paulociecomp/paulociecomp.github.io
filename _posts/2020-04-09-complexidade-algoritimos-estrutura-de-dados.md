...
Olhando para o array de 5 elementos, podemos identificar facilmente quais são esses elementos e onde estão posicionados, mas o computador não possui olhos, então ele não possui conhecimento dos elmentos do array. O que o computador conhece é onde o array começa e qual o seu tamanho.
...
Aprendemos que velocidade não se mede por tempo e sim por etapas. Vimos algumas operações e seus respectivos graus de eficiência e arrays. E percebemos que não só o tipo de estrutura de dados influencia na performance, mas também o algoritmo empregado para executar operações. 
